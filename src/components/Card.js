...
export const Card = ({movie}) => {
  ...
  const image = poster_path ? `https://image.tmdb.org/t/p/w500/${poster_path}`: "https://img.freepik.com/premium-vector/movie-background-film-frames-tape-reels-camera-video-illustrations-vector-movie-tape-cinema-film-cinematography-negative-filmstrip_80590-8801.jpg?w=740" ;
