    ...
    <header>
      <nav className="bg-white border-gray-200 border-b-2 dark:bg-gray-900">
        ...
        <Link to="/" className="flex items-center">
            <img src="https://cdn.colorexpertsbd.com/wp-content/uploads/2018/05/011_1.jpg" className="h-8 mr-3" alt="FilmiFy Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FilmiFy</span>
        </Link>
